                    ...
                    <div className="row">
                        ...
                        <div className="row women" id="carousel-slide">
                            <Carousel infinite="true"
                                ...
                                partialVisible={true} interval={3000}
                                touch={true} arrows={false}
                                responsive={responsive}
                                renderButtonGroupOutside={true}
                                swipeable={true} draggable={false} autoPlay={true}
                                autoPlaySpeed={2000} containerClass="carousel-new">
                                <div className="cards overflow-hidden">
                                    <div className="bg-grey">
                                        <img src={dressimg} className="img-fluid" alt="Koovs product Front image" />
                                        <img src={headbandimg} alt="Koovs rear product image" className="rear-img" />
